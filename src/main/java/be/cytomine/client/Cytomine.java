...
public class Cytomine {
	...
	} // TODO=> RENAME IMAGE TO IMAGEINSTANCE
	...
	public ImageServers getAbstractImageServers(AbstractImage abstractImage) throws CytomineException {
		...
		return fetchModel(imageServers);
	}
	...
	public ImageInstanceCollection getImageInstancesByOffsetWithMax(Long idProject, int offset, int max)
	...
	public AnnotationTerm addAnnotationTerm(Long idAnnotation, Long idTerm, Long idExpectedTerm, Long idUser, double rate)
			throws CytomineException {
		AnnotationTerm annotationTerm = new AnnotationTerm();
		annotationTerm.set("annotation", idAnnotation);
		annotationTerm.set("annotation", idAnnotation);
	...
	public User addUser(String username, String firstname, String lastname, String email, String password)
			throws CytomineException {
		User user = new User();
	...
	public ReviewedAnnotationCollection getReviewedAnnotationsByTermAndImage(Long idTerm, Long idImage)
			throws CytomineException {
	...
	public Property addDomainProperties(String domain, Long domainIdent, String key, String value)
			throws CytomineException {
		Property property = new Property();
		property.set("domain", domain);
		property.set("domainIdent", domainIdent);
	...
	public PropertyCollection getKeysForDomain(String domain, String nameIdDomain, Long idDomain)
			throws CytomineException {
		PropertyCollection properties = new PropertyCollection(offset, max);
	...
	public SearchCollection getSearch(String keywords, Operator operator, Filter filter, List<Long> idProjects)
			throws CytomineException {
	...
	public ImageGroup addImageGroup(Long idProject, String name) throws CytomineException {
		ImageGroup imageGroup = new ImageGroup();
		imageGroup.set("project", idProject + "");
		imageGroup.set("name", name);
		return saveModel(imageGroup);
	}
	...
	public UploadedFileCollection getUploadedFiles(boolean deleted) throws CytomineException {
		...
		files.addParams("deleted", (deleted) ? "true" : "false");
	...
	public AttachedFile uploadAttachedFile(String file, String domainClassName, Long domainIdent)
			throws CytomineException {
