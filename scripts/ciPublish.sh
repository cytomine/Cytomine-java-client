...
docker build --rm -f scripts/docker/Dockerfile-publish.build -t cytomine/cytomine-java-client-publish \
...
containerId=$(docker create cytomine/cytomine-java-client-publish)
